...
<?php endif; ?>
                      ...
                      <div class="p-2 w-1/2 mx-auto">
                        <div class="relative flex justify-around">
                          <div>
                            <input type="radio" name="is_selling" value="1" class="mr-2" <?php if($shop->is_selling === 1): ?>{checked}<?php endif; ?>>販売中
                          </div>
                          <div>
                            <input type="radio" name="is_selling" value="0" class="mr-2" <?php if($shop->is_selling === 0): ?>{checked}<?php endif; ?>>停止中                            
                          </div>
                        </div>
                      </div>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\laravel\umarche\resources\views/owner/shops/edit.blade.php ENDPATH**/ ?>
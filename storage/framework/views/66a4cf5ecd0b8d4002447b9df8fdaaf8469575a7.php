...
<?php endif; ?>
            ...
            <div class="flex items-center justify-end mt-4">
                <?php if(Route::has('admin.password.request')): ?>
                    <a class="underline text-sm text-gray-600 hover:text-gray-900" href="<?php echo e(route('admin.password.request')); ?>">
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\laravel\umarche\resources\views/admin/auth/login.blade.php ENDPATH**/ ?>